...
public class MainMorse extends ActivityGroup implements OnClickListener, TabContentFactory, RadioGroup.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Morse.analyseAvailable())
        	analyze_button.setEnabled(true);
        if(Morse.bruteAvailable())
	...
	public void onClick(View v) {
			...
			case R.id.algos_button_addcipher:
				//this function allow to add another cipher to the ciphered text, to increase "shadow" of the message
			...
			case R.id.algos_button_about:
				int text = R.string.mainmorse_about_text;
				int title = R.string.mainmorse_about_title;
			...
			case R.id.main_basic_button_go:
					if(radio_cipher.isChecked()) {
						if(!(plain_edit_text.getText().toString().equals("")))
							cipher_edit_text.setText(Morse.cipher(plain_edit_text.getText().toString()));
					}	
					else if(radio_decipher.isChecked()) {
						if(!(cipher_edit_text.getText().toString().equals("")))
							plain_edit_text.setText(Morse.decipher(cipher_edit_text.getText().toString()));
					}
				break;
			}
